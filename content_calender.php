 ...
 * Description:       This is a content calender plugin for management of content using Calender.
 * Version:           1.0.0
 * Author:            Avinash Jha
 * Author URI:        https://https://avinash.wisdmlabs.net/
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Text Domain:       content_calender
 ...
 * This action is documented in includes/class-content_calender-activator.php
 */
function activate_content_calender() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-content_calender-activator.php';
	Content_calender_Activator::activate();
}

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/class-content_calender-deactivator.php
 */
function deactivate_content_calender() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-content_calender-deactivator.php';
 ...
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-content_calender.php';
